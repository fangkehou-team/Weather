package org.eu.fangkehou.weather.citypicker;
...
import org.eu.fangkehou.weather.citypicker.adapter.CityListAdapter;
import org.eu.fangkehou.weather.citypicker.adapter.InnerListener;
import org.eu.fangkehou.weather.citypicker.adapter.OnPickListener;
import org.eu.fangkehou.weather.citypicker.adapter.decoration.DividerItemDecoration;
import org.eu.fangkehou.weather.citypicker.adapter.decoration.SectionItemDecoration;
...
import org.eu.fangkehou.weather.citypicker.model.LocateState;
import org.eu.fangkehou.weather.citypicker.model.LocatedCity;
import org.eu.fangkehou.weather.citypicker.util.ScreenUtil;
import org.eu.fangkehou.weather.citypicker.view.SideIndexBar;
...
public class CityPickerDialogFragment extends DialogFragment implements TextWatcher,
    ...
    private List<ChosenCity> mChosenCities;
    ...
    public void setHotCities(List<ChosenCity> data){
        if (data != null){
            this.mChosenCities = data;
        }
    }
    ...
    private void initViews() {
        ...
        mAdapter = new CityListAdapter(getActivity(), mAllCities, mChosenCities, locateState);
    ...
    private void initData() {
        ...
        //初始化热门城市
        if (mChosenCities == null) {
            mChosenCities = new ArrayList<>();
            mChosenCities.add(new ChosenCity("北京", "北京", "101010100"));
            mChosenCities.add(new ChosenCity("上海", "上海", "101020100"));
            mChosenCities.add(new ChosenCity("广州", "广东", "101280101"));
            mChosenCities.add(new ChosenCity("深圳", "广东", "101280601"));
            mChosenCities.add(new ChosenCity("天津", "天津", "101030100"));
            mChosenCities.add(new ChosenCity("杭州", "浙江", "101210101"));
            mChosenCities.add(new ChosenCity("南京", "江苏", "101190101"));
            mChosenCities.add(new ChosenCity("成都", "四川", "101270101"));
            mChosenCities.add(new ChosenCity("武汉", "湖北", "101200101"));
        }
        ...
        mAllCities.add(1, new ChosenCity("热门城市", "未知", "0"));
        mResults = mAllCities;
    }
